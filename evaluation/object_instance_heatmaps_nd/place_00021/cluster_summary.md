...
- representative_description: Rectangular beige/cream pillow with thin blue-gray horizontal stripes on a woven fabric surface, slightly wrinkled and horizontally oriented in a tight crop; appears to be a standard bed pillow photographed close up (approx. 0.6 m from camera).
- same_view_collision: True
- offending_view_ids: view_00108, view_00111, view_00112, view_00115, view_00128, view_00131
...
## Cluster 1
- candidate_instance_id: place:place_00021:cluster_001
- num_members: 12
- representative_label: dresser
- representative_description: Partial, close-up view of a dark brown wooden dresser showing the side panel and several drawer fronts with small metal knobs; surface appears slightly glossy and worn, cut off at the right edge, estimated ~0.6 m from the camera.
- same_view_collision: True
- offending_view_ids: view_00111, view_00115, view_00131
...
## Cluster 2
- candidate_instance_id: place:place_00021:cluster_002
- num_members: 6
- representative_label: table lamp
- representative_description: Beige tapered fabric lampshade with dark trim sitting on a twisted dark-brown wood (or wood-look) column and a stepped square base; lamp is switched on and emitting warm light; object is mostly visible and centered in the crop; approximate distance ~0.8 m from camera.
...
## Cluster 3
- candidate_instance_id: place:place_00021:cluster_003
- num_members: 8
- representative_label: door
- representative_description: object: door | attributes: white paint, raised panels, metal lever handles (brushed finish), two-door set with center seam | camera_relation: distance=0.8, bearing=-10.0, laterality=center, verticality=middle | global_anchor: x=-1.0, z=-5.5 | surroundings: wall | relation=surrounding/backing | primary_dist=0.1 | global=(-1.5,-5.5); curtain | relation=immediately right of | primary_dist=0.4 | global=(-1.5,-6.0); bed | relation=beyond and to the right of | primary_dist=1.2 | global=(-2.0,-6.5); dresser | relation=further right edge of frame | primary_dist=1.5 | global=(-2.0,-7.0) | scene_context: floor_pattern=unknown; scene_attributes=pair of white paneled closet doors centered in frame, beige/textured painted walls, gray curtain/drape along right opening, partial view into bedroom with bed and dresser visible, decorative door molding and lever handles; wall_color=beige
- same_view_collision: True
- offending_view_ids: view_00110, view_00113
...
## Cluster 4
- candidate_instance_id: place:place_00021:cluster_004
- num_members: 16
- representative_label: curtain
- representative_description: object: curtain | attributes: gray, heavy fabric, full-length | camera_relation: distance=1.2, bearing=30.0, laterality=right, verticality=high | global_anchor: x=-1.5, z=-6.0 | surroundings: door | relation=immediately left of | primary_dist=0.4 | global=(-1.0,-5.5); bed | relation=in front of / partially blocking | primary_dist=0.9 | global=(-2.0,-6.5); dresser | relation=left of (from dresser perspective) | primary_dist=1.1 | global=(-2.0,-7.0) | scene_context: floor_pattern=unknown; scene_attributes=pair of white paneled closet doors centered in frame, beige/textured painted walls, gray curtain/drape along right opening, partial view into bedroom with bed and dresser visible, decorative door molding and lever handles; wall_color=beige
- same_view_collision: True
- offending_view_ids: view_00109, view_00113, view_00114, view_00129
...
## Cluster 5
- candidate_instance_id: place:place_00021:cluster_005
- num_members: 3
- representative_label: fan
- representative_description: Overhead ceiling-mounted fan with multiple dark-stained wooden blades and a central frosted glass light shade (shows slight yellowish discoloration); metal mounting hardware visible; view from below and partly edge-cropped in the image; approximately 2.5 m from the camera.
- same_view_collision: False
...
## Cluster 6
- candidate_instance_id: place:place_00021:cluster_006
- num_members: 3
- representative_label: window
- representative_description: Interior rectangular window with a white frame and closed white horizontal slatted blinds filling the opening; dark navy curtains flank both sides and the lower-left blind slats are slightly misaligned with minor occlusion from a wooden piece of furniture at the bottom-left; approximate distance from camera ~2.0 m.
- same_view_collision: False
...
## Cluster 7
- candidate_instance_id: place:place_00021:cluster_007
- num_members: 3
- representative_label: tv
- representative_description: Partial wall-mounted black flat-screen TV with a thin dark bezel and glossy reflective screen showing blurred vertical reflections; screen appears mostly dark/turned-off and the right edge is cropped by the image border — estimated ~1.5 m from the camera.
- same_view_collision: False
